...
const words = ["recycle", "compost", "plant", "water", "organic", "windmill", "solar", "plastic", "carbon", "bamboo", "hybrid", "biofuel", "habitat", "oxygen", "fungi", "wetland", "tundra", "rainforest", "ecofriendly", "upcycle", "permaculture", "biodiesel", "tree", "earth", "leaf", "sun", "wind", "air", "eco"];
...
const riddles = {
    ...
    bamboo: "🎍 I grow fast and am stronger than steel (sometimes)—what plant am I?",
    hybrid: "🚗 I combine gas and electricity to drive cleaner—what kind of vehicle am I?",
